 ...
 * <dd>SMOOTH - Indicates direct manipulation of upper and lower values are computed smoothly from the exact
...
public class RangeSlider extends Canvas {
   ...
   * we generate at least ten divisions, but fewer is the ticks are too compact.
...
// TODO consider API for setting accelerator values
   ...
   * be ignored if they are negative or the min value is not less than the max.
