 ...
 *
 * Contributors:
 *     XXXX (XXX) - initial API and implementation (on SWING), 
...
/**
 * Instances of this class are controls which background's texture is brushed metal "à la Mac"
 */
public class BrushedMetalComposite extends Composite {
     ...
     * @param pixels An array containing the pixel data to place between x,y and x+w-1, y+h-1.
     */
     ...
     * @return the number. If c is negative, returns 0. If c is greater than 255, returns 255.
     */
    ...
    /**
     * Apply a blur filter to an array of int that represents and image which size is width columns * 1 row
     * 
     ...
     * 
     * @exception IllegalArgumentException <ul>
     *                <li>ERROR_INVALID_ARGUMENT - if the value is not between 0 and 1 inclusive</li>
     *                </ul>
     */
    ...
    /**
     * @return the color of the metal. Please notice that this color is a new SWT object, so it has to be disposed !
     */
