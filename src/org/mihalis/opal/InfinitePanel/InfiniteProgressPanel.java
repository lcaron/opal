...
/**
 * Instances of this class are controls located on the top of a shell. They display a ticker that indicates to the user that a long task operation is running
 */
public class InfiniteProgressPanel {
     ...
     * 
     * @param shell a shell that will be the parent of the new instance (cannot be null)
    ...
    /**
     * Returns the infinite progress panel for the shell. If no infinite panel has been declared, returns null.
     * 
     * @param shell the shell for which we are trying to get the associated progess panel
     * @return the progress panel associated to shell, or null if there is no progress panel
     */
     ...
     * @return <code>true</code> if the shell has an associated panel, <code>false</code> otherwise
     */
    ...
    /**
     * @param defaultColor the new default color for the ticker's bars. Please notice that the previous color is disposed.
     * 
     * @exception IllegalArgumentException <ul>
     *                <li>ERROR_INVALID_ARGUMENT - if the animation is running</li>
     *                </ul>
    ...
    /**
     * @param selectionColor the new selection color for the ticker's bars. Please notice that the previous color is disposed.
     * 
     * @exception IllegalArgumentException <ul>
     *                <li>ERROR_INVALID_ARGUMENT - if the animation is running</li>
     *                </ul>
    ...
    /**
     * @param textColor the text color. Please notice that the previous color is disposed.
     * 
     * @exception IllegalArgumentException <ul>
     *                <li>ERROR_INVALID_ARGUMENT - if the animation is running</li>
     *                </ul>
    ...
    /**
     * @param textFont the new text font. Please notice that the previous font set is disposed.
     * 
     * @exception IllegalArgumentException <ul>
     *                <li>ERROR_INVALID_ARGUMENT - if the animation is running</li>
     *                </ul>
