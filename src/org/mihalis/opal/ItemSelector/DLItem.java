...
public class DLItem extends OpalItem {
     ...
     * @param foregroundColor the foreground color displayed in the DualList widget for this item
     */
     ...
     * @param image the image displayed in the DualList widget for this item
     * @param foregroundColor the foreground color displayed in the DualList widget for this item
     * @param backgroundColor the background color displayed in the DualList widget for this item
     */
