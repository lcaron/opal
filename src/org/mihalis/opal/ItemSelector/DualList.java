...
public class DualList extends Composite {
     ...
     * @param verticalExpand if <code>true</code>, the button will take all the available space vertically
     ...
     * <p>
     * Note: To add an item at the end of the list, use the result of calling <code>getItemCount()</code> as the index or use <code>add(DLItem)</code>.
     * </p>
     * 
     * @param item the new item
    ...
    /**
     * Returns a (possibly empty) array of <code>DLItem</code>s which are the items in the receiver.
     * <p>
    ...
    /**
     * Returns a (possibly empty) list of <code>DLItem</code>s which are the items in the receiver.
     * <p>
     * Note: This is not the actual structure used by the receiver to maintain its list of items, so modifying the array will not affect the receiver.
     * </p>
     * 
    ...
    /**
     * Returns an array of <code>DLItem</code>s that are currently selected in the receiver. An empty array indicates that no items are selected.
     * <p>
    ...
    /**
     * Returns a list of <code>DLItem</code>s that are currently selected in the receiver. An empty array indicates that no items are selected.
     * <p>
     * Note: This is not the actual structure used by the receiver to maintain its selection, so modifying the array will not affect the receiver.
     * </p>
     * 
     ...
     * 
     * @exception IllegalArgumentException <ul>
     *                <li>ERROR_INVALID_RANGE - if either the start or end are not between 0 and the number of elements in the list minus 1 (inclusive) or if start>end</li>
     *                </ul>
     * @exception SWTException <ul>
     *                <li>ERROR_WIDGET_DISPOSED - if the receiver has been disposed</li>
     *                <li>ERROR_THREAD_INVALID_ACCESS - if not called from the thread that created the receiver</li>
     ...
     * @exception IllegalArgumentException <ul>
     *                <li>ERROR_NULL_ARGUMENT - if the item is null</li>
     *                <li>ERROR_INVALID_ARGUMENT - if the item is not found in the list</li>
     *                </ul>
     * @exception SWTException <ul>
     *                <li>ERROR_WIDGET_DISPOSED - if the receiver has been disposed</li>
     *                <li>ERROR_THREAD_INVALID_ACCESS - if not called from the thread that created the receiver</li>
     ...
     *                <li>ERROR_INVALID_ARGUMENT - if an item in the items list is null</li>
     *                </ul>
     * @exception SWTException <ul>
     *                <li>ERROR_WIDGET_DISPOSED - if the receiver has been disposed</li>
     *                <li>ERROR_THREAD_INVALID_ACCESS - if not called from the thread that created the receiver</li>
     ...
     * @param isSelected if <code>true</code>, fill the table with the selection. Otherwise, fill the table with the unselected items.
     */
