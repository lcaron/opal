...
class FooterArea extends DialogArea {
	...
	public FooterArea(final Dialog parent) {
		...
		this.expandedLabelText = Dialog.getLabel("FewerDetails");
		this.collapsedLabelText = Dialog.getLabel("MoreDetails");
		this.timer = -1;
	...
	private void createDetails(final int numberOfColumns) {
		...
		label.setText(isExpanded() ? this.expandedLabelText : this.collapsedLabelText);
			...
			public void handleEvent(final Event event) {
				if (FooterArea.this.parent.getMessageArea().getException() != null) {
					...
					if (label.getText().equals(FooterArea.this.expandedLabelText)) {
						...
						label.setText(FooterArea.this.expandedLabelText);
						icon.setImage(getFewerDetailsImage());
						createExpandedPanel(numberOfColumnsParam);
						FooterArea.this.parent.pack();
					}
				}
			}
