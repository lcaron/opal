...
public class SwitchButton extends Canvas {
     ...
     */
    private List<SelectionListener> listOfSelectionListeners;
    ...
    /**
     * @param round the round flag to set. If true, the widget is composed of round rectangle instead of rectangles
     * @exception SWTException <ul>
     *                <li>ERROR_WIDGET_DISPOSED - if the receiver has been disposed</li>
     *                <li>ERROR_THREAD_INVALID_ACCESS - if not called from the thread that created the receiver</li>
     *                </ul>
    ...
    /**
     * @param focusColor the focus color to set. If null, no focus effect is displayed.
     * @exception SWTException <ul>
     *                <li>ERROR_WIDGET_DISPOSED - if the receiver has been disposed</li>
     *                <li>ERROR_THREAD_INVALID_ACCESS - if not called from the thread that created the receiver</li>
     *                </ul>
    ...
    /**
     * @param unselectedForegroundColor the foreground color of the left part of the widget (selection is on)
     * @exception SWTException <ul>
     *                <li>ERROR_WIDGET_DISPOSED - if the receiver has been disposed</li>
     *                <li>ERROR_THREAD_INVALID_ACCESS - if not called from the thread that created the receiver</li>
     *                </ul>
    ...
    /**
     * @param unselectedBackgroundColor the background color of the left part of the widget (selection is on)
     * @exception SWTException <ul>
     *                <li>ERROR_WIDGET_DISPOSED - if the receiver has been disposed</li>
     *                <li>ERROR_THREAD_INVALID_ACCESS - if not called from the thread that created the receiver</li>
     *                </ul>
