...
public class HorizontalSpinner extends Composite {
		...
		this.text.addKeyListener(new KeyAdapter() {
			...
			public void keyReleased(final KeyEvent e) {
				if (e.keyCode == SWT.ARROW_UP) {
					increaseValue(HorizontalSpinner.this.increment);
				}
				if (e.keyCode == SWT.ARROW_DOWN) {
					decreaseValue(HorizontalSpinner.this.increment);
				}
				if (e.keyCode == SWT.PAGE_UP) {
					increaseValue(HorizontalSpinner.this.pageIncrement);
				}
				if (e.keyCode == SWT.PAGE_DOWN) {
					decreaseValue(HorizontalSpinner.this.pageIncrement);
				}
			}
		...
		this.text.addFocusListener(new org.eclipse.swt.events.FocusAdapter() {
			...
			public void focusLost(final org.eclipse.swt.events.FocusEvent e) {
				if (HorizontalSpinner.this.text.getText().trim().equals("")) {
					setSelection(HorizontalSpinner.this.storedValue);
				}
			}
	...
	private boolean verifyEntryAndStoreValue(final String entry, final int keyCode) {
		...
		try {
			...
			this.storedValue = (int) (d * Math.pow(10, getDigits()));
	...
	public void setSelection(int selection) {
		...
		this.text.setText(convertSelection());
		this.text.selectAll();
		this.text.setFocus();
	...
	private String convertSelection() {
		...
		final String temp = String.valueOf(this.storedValue * Math.pow(10, -1 * getDigits()));
